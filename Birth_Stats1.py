...
Data = pd.read_csv("Pop Stats - Numeric Data.csv")

# Melt the age columns into rows
Births = pd.melt(Data, id_vars=['Year', 'Birth Order'],
...
############################## Change These Variables to Produce Different Plots ##################
# Select age, birth order and desired plot

# 0 = by age
# 1 = by order
birth_plot = birth_plots[1]
...
# 7 = '45-49'
# 8 = '50-54'
age = ages[1] # Select age from 0-9
...
# 9 = 'Not Stated'
order = orders[0] # Select order from 0-9
